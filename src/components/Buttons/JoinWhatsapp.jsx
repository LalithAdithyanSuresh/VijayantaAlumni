...
function JoinWhatsapp({link1,link2}) {
    ...
    const BoxStyle = open
        ? "absolute w-64 h-32 bg-[#54c451] top-[-5rem] left-[-13rem] z-0 border-[6px] border-white shadow-md ease-in-out duration-500 rounded"
        : "absolute w-0 h-0 bg-[#54c451] top-[3rem] left-[3rem] z-0 border-[6px] border-white shadow-md ease-in-out duration-500 rounded"
    ...
    return ( 
        ...
        <div className={OverallStyle} onClick={toggle}>
            ...
            <div className= "absolute w-64 h-32 bg-[#54c451] top-[-5rem] left-[-13rem] z-0 border-[6px] border-white shadow-md ease-in-out duration-500 rounded-[0.75rem]">
